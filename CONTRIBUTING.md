# Contributing to mc-healthcheck
...
3. **`README.md`**
   - Update any references to `miikkak/mc-healthcheck` or `miikkak/mc-server-container` to
     point to your fork, if relevant to your use case
...
- `feat: add --json output to status-bedrock`
- `fix: guard against VarInt length overflow`
- `docs: document the status-bedrock RakNet handshake`
...
- Comments explain _why_ a decision was made (not what the code already says) - especially for
  protocol-parsing edge cases that aren't obvious from the code alone

## Branch Workflow

- **Never commit directly to `main`**
- Create feature branches from `main`
- Name branches descriptively (e.g., `feat/json-output`, `fix/varint-overflow`)
